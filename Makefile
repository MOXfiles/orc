...
pkgdatadir = $(datadir)/orc
pkgincludedir = $(includedir)/orc
pkglibdir = $(libdir)/orc
pkglibexecdir = $(libexecdir)/orc
...
DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/Makefile.am \
	...
	$(srcdir)/config.h.in $(srcdir)/orc-uninstalled.pc.in \
	$(srcdir)/orc.pc.in COPYING README TODO compile config.guess \
...
am__aclocal_m4_deps = $(top_srcdir)/m4/ac_libtool_tags.m4 \
	...
	$(top_srcdir)/m4/as-nano.m4 $(top_srcdir)/m4/gtk-doc.m4 \
...
ACLOCAL = ${SHELL} /usr/src/orc/orc/missing aclocal-1.13
ACLOCAL_AMFLAGS = -I m4
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AS = as
AUTOCONF = ${SHELL} /usr/src/orc/orc/missing autoconf
AUTOHEADER = ${SHELL} /usr/src/orc/orc/missing autoheader
AUTOMAKE = ${SHELL} /usr/src/orc/orc/missing automake-1.13
AWK = gawk
CC = gcc
CCAS = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /usr/src/orc/orc/missing makeinfo
MANIFEST_TOOL = :
...
OBJDUMP = objdump
OBJEXT = o
ORC_CFLAGS =  -Wall $(ERROR_CFLAGS) -I$(top_srcdir)
ORC_LIBS = $(top_builddir)/orc/liborc-0.4.la -lm -lrt
...
STRIP = strip
VERSION = 0.4.17
abs_builddir = /usr/src/orc/orc
abs_srcdir = /usr/src/orc/orc
abs_top_builddir = /usr/src/orc/orc
abs_top_srcdir = /usr/src/orc/orc
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /usr/src/orc/orc/install-sh
...
orc-uninstalled.pc: $(top_builddir)/config.status $(srcdir)/orc-uninstalled.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
orc.pc: $(top_builddir)/config.status $(srcdir)/orc.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
